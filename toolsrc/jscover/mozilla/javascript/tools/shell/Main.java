...
import jscover.mozilla.javascript.GeneratedClassLoader;
import jscover.mozilla.javascript.Kit;
import jscover.mozilla.javascript.NativeArray;
import jscover.mozilla.javascript.RhinoException;
import jscover.mozilla.javascript.Script;
import jscover.mozilla.javascript.Scriptable;
import jscover.mozilla.javascript.ScriptableObject;
import jscover.mozilla.javascript.SecurityController;
import jscover.mozilla.javascript.commonjs.module.ModuleScope;
import jscover.mozilla.javascript.commonjs.module.Require;
import jscover.mozilla.javascript.tools.SourceReader;
    ...
    private static void initJavaPolicySecuritySupport()
    {
        ...
        try {
            Class<?> cl = Class.forName
                ("jscover.mozilla.javascript.tools.shell.JavaPolicySecurity");
