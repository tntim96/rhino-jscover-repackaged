...
public class Main {
     ...
     * {@link jscover.mozilla.javascript.tools.shell.Main} shell session.
     */
    public static void main(String[] args) {
        ...
        Global global = jscover.mozilla.javascript.tools.shell.Main.getGlobal();
        global.setIn(main.getIn());
        global.setOut(main.getOut());
        global.setErr(main.getErr());

        main.attachTo(
            jscover.mozilla.javascript.tools.shell.Main.shellContextFactory);
        ...
        jscover.mozilla.javascript.tools.shell.Main.exec(args);
    }
