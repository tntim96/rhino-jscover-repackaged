...
package jscover.mozilla.classfile;

import jscover.mozilla.javascript.ObjToIntMap;
import jscover.mozilla.javascript.ObjArray;
import jscover.mozilla.javascript.UintMap;
        ...
        try {
            ...
            if (is == null) {
                is = ClassLoader.getSystemResourceAsStream(
                    "jscover/mozilla/classfile/ClassFileWriter.class");
            }
