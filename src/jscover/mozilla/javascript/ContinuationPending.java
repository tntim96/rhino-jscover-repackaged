...
/**
 * Exception thrown by
 * {@link jscover.mozilla.javascript.Context#executeScriptWithContinuations(Script, Scriptable)}
 * and {@link jscover.mozilla.javascript.Context#callFunctionWithContinuations(Callable, Scriptable, Object[])}
 * when execution encounters a continuation captured by
 * {@link jscover.mozilla.javascript.Context#captureContinuation()}.
 * Exception will contain the captured state needed to restart the continuation
 * with {@link jscover.mozilla.javascript.Context#resumeContinuation(Object, Scriptable, Object)}.
 * @author Norris Boyd
 */
public class ContinuationPending extends RuntimeException {
     ...
     * calling {@link jscover.mozilla.javascript.Context#executeScriptWithContinuations(Script, Scriptable)}
     * and {@link jscover.mozilla.javascript.Context#callFunctionWithContinuations(Callable, Scriptable, Object[])}
     ...
     * {@link jscover.mozilla.javascript.Context#resumeContinuation(Object, Scriptable, Object)}.
