...
import jscover.mozilla.javascript.debug.DebuggableObject;
import jscover.mozilla.javascript.annotations.JSConstructor;
import jscover.mozilla.javascript.annotations.JSFunction;
import jscover.mozilla.javascript.annotations.JSGetter;
import jscover.mozilla.javascript.annotations.JSSetter;
import jscover.mozilla.javascript.annotations.JSStaticFunction;
                                                  ...
                                                  ConstProperties
{
     ...
     *
     * @see jscover.mozilla.javascript.ScriptableObject#getAttributes(String)
     * @see jscover.mozilla.javascript.ScriptableObject#setAttributes(String, int)
     */
     ...
     *
     * @see jscover.mozilla.javascript.ScriptableObject#getIds()
     * @see jscover.mozilla.javascript.ScriptableObject#getAttributes(String)
     * @see jscover.mozilla.javascript.ScriptableObject#setAttributes(String, int)
     */
     ...
     *
     * @see jscover.mozilla.javascript.ScriptableObject#delete(String)
     * @see jscover.mozilla.javascript.ScriptableObject#getAttributes(String)
     * @see jscover.mozilla.javascript.ScriptableObject#setAttributes(String, int)
     */
     ...
     * @see jscover.mozilla.javascript.ScriptableObject#has(String, Scriptable)
     * @see jscover.mozilla.javascript.ScriptableObject#READONLY
     * @see jscover.mozilla.javascript.ScriptableObject#DONTENUM
     * @see jscover.mozilla.javascript.ScriptableObject#PERMANENT
     * @see jscover.mozilla.javascript.ScriptableObject#EMPTY
     */
     ...
     * @see jscover.mozilla.javascript.Function
     * @see jscover.mozilla.javascript.FunctionObject
     * @see jscover.mozilla.javascript.ScriptableObject#READONLY
     * @see jscover.mozilla.javascript.ScriptableObject
