...
public abstract class VMBridge
{
    ...
    {
        String[] classNames = {
            "jscover.mozilla.javascript.VMBridge_custom",
            "jscover.mozilla.javascript.jdk15.VMBridge_jdk15",
            "jscover.mozilla.javascript.jdk13.VMBridge_jdk13",
            "jscover.mozilla.javascript.jdk11.VMBridge_jdk11",
        };
