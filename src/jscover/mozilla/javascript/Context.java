...
import jscover.mozilla.javascript.debug.Debugger;
...
public class Context
{
    ...
    /**
     * @deprecated
     * @see ContextFactory#addListener(jscover.mozilla.javascript.ContextFactory.Listener)
     * @see ContextFactory#getGlobal()
     */
    public static void addContextListener(ContextListener listener)
    {
        // Special workaround for the debugger
        String DBG = "jscover.mozilla.javascript.tools.debugger.Main";
        if (DBG.equals(listener.getClass().getName())) {
            Class<?> cl = listener.getClass();
            Class<?> factoryClass = Kit.classOrNull(
                "jscover.mozilla.javascript.ContextFactory");
    ...
    /**
     * @deprecated
     * @see ContextFactory#removeListener(jscover.mozilla.javascript.ContextFactory.Listener)
     * @see ContextFactory#getGlobal()
     */
     ...
     *
     * @see jscover.mozilla.javascript.ErrorReporter
     */
     ...
     * @see jscover.mozilla.javascript.SecurityController
     */
            ...
            throws ContinuationPending
    {
        ...
        return Interpreter.restartContinuation(
                (jscover.mozilla.javascript.NativeContinuation) continuation,
                this, scope, args);
    }
     ...
     * @exception IOException if an IOException was generated by the Reader
     * @see jscover.mozilla.javascript.Script
     */
    ...
    private static Class<?> codegenClass = Kit.classOrNull(
                             "jscover.mozilla.javascript.optimizer.Codegen");
    private static Class<?> interpreterClass = Kit.classOrNull(
                             "jscover.mozilla.javascript.Interpreter");
    ...
    RegExpProxy getRegExpProxy()
    {
        if (regExpProxy == null) {
            Class<?> cl = Kit.classOrNull(
                          "jscover.mozilla.javascript.regexp.RegExpImpl");
            if (cl != null) {
