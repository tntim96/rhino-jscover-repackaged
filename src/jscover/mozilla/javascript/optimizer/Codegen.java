...
package jscover.mozilla.javascript.optimizer;

import jscover.mozilla.javascript.*;
import jscover.mozilla.javascript.ast.FunctionNode;
import jscover.mozilla.javascript.ast.Jump;
import jscover.mozilla.javascript.ast.Name;
import jscover.mozilla.javascript.ast.ScriptNode;
import jscover.mozilla.classfile.*;

import java.util.*;
import java.lang.reflect.Constructor;

import static jscover.mozilla.classfile.ClassFileWriter.ACC_FINAL;
import static jscover.mozilla.classfile.ClassFileWriter.ACC_PRIVATE;
import static jscover.mozilla.classfile.ClassFileWriter.ACC_PUBLIC;
import static jscover.mozilla.classfile.ClassFileWriter.ACC_STATIC;
import static jscover.mozilla.classfile.ClassFileWriter.ACC_VOLATILE;
...
public class Codegen implements Evaluator
{
                          ...
                          boolean returnFunction)
    {
        ...
        String mainClassName = "jscover.mozilla.javascript.gen." + baseName + "_" + serial;
    ...
    private byte[] generateCode(String encodedSource)
    {
        ...
        if (hasScript) {
            cfw.addInterface("jscover/mozilla/javascript/Script");
...
*/
        ...
        cfw.addInvoke(ByteCode.INVOKEVIRTUAL,
                      "jscover/mozilla/javascript/BaseFunction",
                      "createObject",
                      "(Ljscover/mozilla/javascript/Context;"
                      +"Ljscover/mozilla/javascript/Scriptable;"
                      +")Ljscover/mozilla/javascript/Scriptable;");
        ...
        cfw.add(ByteCode.INSTANCEOF, "jscover/mozilla/javascript/Scriptable");
        cfw.add(ByteCode.IFEQ, exitLabel);
        // cast direct call result
        cfw.add(ByteCode.CHECKCAST, "jscover/mozilla/javascript/Scriptable");
    ...
    private void generateCallMethod(ClassFileWriter cfw)
    {
        ...
        cfw.addALoad(1); //cx
        cfw.addInvoke(ByteCode.INVOKESTATIC,
                      "jscover/mozilla/javascript/ScriptRuntime",
                      "hasTopCall",
                      "(Ljscover/mozilla/javascript/Context;"
                      +")Z");
        ...
        cfw.addInvoke(ByteCode.INVOKESTATIC,
                      "jscover/mozilla/javascript/ScriptRuntime",
                      "doTopCall",
                      "(Ljscover/mozilla/javascript/Callable;"
                      +"Ljscover/mozilla/javascript/Context;"
                      +"Ljscover/mozilla/javascript/Scriptable;"
                      +"Ljscover/mozilla/javascript/Scriptable;"
                      +"[Ljava/lang/Object;"
    ...
    private void generateMain(ClassFileWriter cfw)
    {
        ...
        cfw.addInvoke(ByteCode.INVOKESTATIC,
                      mainMethodClass,
                      "main",
                      "(Ljscover/mozilla/javascript/Script;[Ljava/lang/String;)V");
                                      ...
                                      OptFunctionNode ofn)
    {
        ...
        cfw.addALoad(SCOPE_ARG);
        cfw.addInvoke(ByteCode.INVOKEVIRTUAL,
                      "jscover/mozilla/javascript/NativeFunction",
                      "initScriptFunction",
                      "(Ljscover/mozilla/javascript/Context;"
                      +"Ljscover/mozilla/javascript/Scriptable;"
                      +")V");
    ...
    private void emitRegExpInit(ClassFileWriter cfw)
    {
        ...
        cfw.addInvoke(ByteCode.INVOKESTATIC,
                      ...
                      "checkRegExpProxy",
                      "(Ljscover/mozilla/javascript/Context;"
                      +")Ljscover/mozilla/javascript/RegExpProxy;");
        ...
        for (int i = 0; i != scriptOrFnNodes.length; ++i) {
            ...
            for (int j = 0; j != regCount; ++j) {
                ...
                cfw.addInvoke(ByteCode.INVOKEINTERFACE,
                              "jscover/mozilla/javascript/RegExpProxy",
                              "compileRegExp",
                              "(Ljscover/mozilla/javascript/Context;"
        ...
        if (num == 0.0) {
            if (1 / num > 0) {
                ...
                cfw.add(ByteCode.GETSTATIC,
                        "jscover/mozilla/javascript/optimizer/OptRuntime",
    ...
    {
        cfw.add(ByteCode.GETSTATIC, "jscover/mozilla/javascript/Undefined",
    ...
    String getBodyMethodSignature(ScriptNode n)
    {
        ...
        sb.append("Ljscover/mozilla/javascript/Context;"
                  +"Ljscover/mozilla/javascript/Scriptable;"
                  +"Ljscover/mozilla/javascript/Scriptable;");
        if (n.getType() == Token.FUNCTION) {
            OptFunctionNode ofn = OptFunctionNode.get(n);
    ...
    static final String REGEXP_INIT_METHOD_SIGNATURE
        =  "(Ljscover/mozilla/javascript/Context;)V";
   ...
   static final String FUNCTION_CONSTRUCTOR_SIGNATURE
        = "(Ljscover/mozilla/javascript/Scriptable;"
          +"Ljscover/mozilla/javascript/Context;I)V";
...
class BodyCodegen
{
    ...
    private void generateGenerator()
    {
        ...
        if (fnCurrent != null)
        {
            ...
            cfw.addInvoke(ByteCode.INVOKEINTERFACE,
                          "jscover/mozilla/javascript/Scriptable",
                          "getParentScope",
                          "()Ljscover/mozilla/javascript/Scriptable;");
        ...
        addScriptRuntimeInvoke("createFunctionActivation",
                               "(Ljscover/mozilla/javascript/NativeFunction;"
                               +"Ljscover/mozilla/javascript/Scriptable;"
                               +"[Ljava/lang/Object;"
                               +")Ljscover/mozilla/javascript/Scriptable;");
        cfw.addAStore(variableObjectLocal);
        ...
        addOptRuntimeInvoke("createNativeGenerator",
                               "(Ljscover/mozilla/javascript/NativeFunction;"
                               +"Ljscover/mozilla/javascript/Scriptable;"
                               +"Ljscover/mozilla/javascript/Scriptable;II"
                               +")Ljscover/mozilla/javascript/Scriptable;");
    ...
    private void generateThrowJavaScriptException()
    {
        cfw.add(ByteCode.NEW,
                        "jscover/mozilla/javascript/JavaScriptException");
        ...
        switch (type) {
              ...
              case Token.REF_CALL:
                ...
                addScriptRuntimeInvoke(
                    ...
                    +"[Ljava/lang/Object;"
                    +"Ljscover/mozilla/javascript/Context;"
                    +")Ljscover/mozilla/javascript/Ref;");
                break;
    ...
    private void generateArrayLiteralFactory(Node node, int count) {
        ...
        argsLocal = firstFreeLocal++;
        localsMax = firstFreeLocal;
        cfw.startMethod(methodName, "(Ljscover/mozilla/javascript/Context;"
                +"Ljscover/mozilla/javascript/Scriptable;"
                +"Ljscover/mozilla/javascript/Scriptable;"
                +"[Ljava/lang/Object;"
                +")Ljscover/mozilla/javascript/Scriptable;",
                                  ...
                                  Node child)
    {
        ...
        if (type == Token.NEW) {
            ...
            callSignature = "(Ljscover/mozilla/javascript/Context;"
                            +"Ljava/lang/Object;"
                            +"[Ljava/lang/Object;"
                            +"Ljscover/mozilla/javascript/Scriptable;"
                            +"Ljscover/mozilla/javascript/Scriptable;"
    ...
    private void visitStandardCall(Node node, Node child)
    {
        ...
        if (firstArgChild == null) {
            if (childType == Token.NAME) {
                ...
                generateFunctionAndThisObj(child, node);
                methodName = "call0";
                signature = "(Ljscover/mozilla/javascript/Callable;"
                            +"Ljscover/mozilla/javascript/Scriptable;"
                            +"Ljscover/mozilla/javascript/Context;"
                            +"Ljscover/mozilla/javascript/Scriptable;"
                            +")Ljava/lang/Object;";
...
*/
        ...
        if (type == Token.NEW) {
            ...
            cfw.addInvoke(ByteCode.INVOKEINTERFACE,
                "jscover/mozilla/javascript/Callable",
                "call",
                "(Ljscover/mozilla/javascript/Context;"
                +"Ljscover/mozilla/javascript/Scriptable;"
                +"Ljscover/mozilla/javascript/Scriptable;"
    ...
    private String exceptionTypeToName(int exceptionType)
    {
        if (exceptionType == JAVASCRIPT_EXCEPTION) {
            return "jscover/mozilla/javascript/JavaScriptException";
        } else if (exceptionType == EVALUATOR_EXCEPTION) {
            return "jscover/mozilla/javascript/EvaluatorException";
        } else if (exceptionType == ECMAERROR_EXCEPTION) {
            return "jscover/mozilla/javascript/EcmaError";
