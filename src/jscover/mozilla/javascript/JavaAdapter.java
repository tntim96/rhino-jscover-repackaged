...
public final class JavaAdapter implements IdFunctionCall
{
                                           ...
                                           String scriptClassName)
    {
        ClassFileWriter cfw = new ClassFileWriter(adapterName,
                                                  superClass.getName(),
                                                  "<adapter>");
        cfw.addField("factory", "Ljscover/mozilla/javascript/ContextFactory;",
                     (short) (ClassFileWriter.ACC_PUBLIC |
                              ClassFileWriter.ACC_FINAL));
        cfw.addField("delegee", "Ljscover/mozilla/javascript/Scriptable;",
                     (short) (ClassFileWriter.ACC_PUBLIC |
                              ClassFileWriter.ACC_FINAL));
        cfw.addField("self", "Ljscover/mozilla/javascript/Scriptable;",
                     (short) (ClassFileWriter.ACC_PUBLIC |
                              ClassFileWriter.ACC_FINAL));
                                     ...
                                     String superName, Constructor<?> superCtor)
    {
        ...
        if (parameters.length == 0) {
            cfw.startMethod("<init>",
                        ...
                        +"Ljscover/mozilla/javascript/ContextFactory;)V",
            ...
            StringBuilder sig = new StringBuilder(
                    "(Ljscover/mozilla/javascript/Scriptable;"
                    +"Ljscover/mozilla/javascript/ContextFactory;");
        ...
        cfw.addInvoke(ByteCode.INVOKESTATIC,
                      "jscover/mozilla/javascript/JavaAdapter",
                                          ...
                                          String scriptClassName)
    {
        ...
        cfw.addInvoke(ByteCode.INVOKESTATIC,
                      "jscover/mozilla/javascript/JavaAdapter",
                      "runScript",
                      "(Ljscover/mozilla/javascript/Script;"
                      +")Ljscover/mozilla/javascript/Scriptable;");
                                     ...
                                     boolean callConvertResult)
    {
        ...
        if (retType == Void.TYPE) {
            ...
            cfw.addInvoke(ByteCode.INVOKESTATIC,
                          "jscover/mozilla/javascript/Context",
                                       ...
                                       Class<?> returnType, boolean convertResult)
    {
        ...
        cfw.addInvoke(ByteCode.INVOKESTATIC,
                      ...
                      "(Ljscover/mozilla/javascript/Scriptable;"
                      +"Ljava/lang/String;"
                      +")Ljscover/mozilla/javascript/Function;");
