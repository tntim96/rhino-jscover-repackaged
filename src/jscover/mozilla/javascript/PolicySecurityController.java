...
import jscover.mozilla.classfile.ByteCode;
import jscover.mozilla.classfile.ClassFileWriter;
...
public class PolicySecurityController extends SecurityController
{
    ...
    private static byte[] loadBytecode()
    {
        ...
        cfw.startMethod("call",
                "(Ljscover/mozilla/javascript/Callable;" + callableCallSig,
        ...
        cfw.addInvoke(ByteCode.INVOKEINTERFACE,
                "jscover/mozilla/javascript/Callable", "call",
                "(" + callableCallSig);
