...
package jscover.mozilla.javascript.jdk15;
...
public class VMBridge_jdk15 extends jscover.mozilla.javascript.jdk13.VMBridge_jdk13
{
    public VMBridge_jdk15() throws SecurityException, InstantiationException {
        try {
            ...
            // jscover.mozilla.javascript.Kit.newInstanceOrNull:
