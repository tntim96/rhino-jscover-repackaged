...
public interface Scriptable {
     ...
     * <LI>jscover.mozilla.javascript.Scriptable objects</LI>
     * <LI>null</LI>
     ...
     * @see jscover.mozilla.javascript.Context#getUndefinedValue
     */
     ...
     * @see jscover.mozilla.javascript.Scriptable#get(String, Scriptable)
     * @see jscover.mozilla.javascript.ScriptableObject#getProperty(Scriptable, String)
     */
     ...
     * @see jscover.mozilla.javascript.ScriptableObject#getProperty(Scriptable, int)
     */
     ...
     * @see jscover.mozilla.javascript.Scriptable#get(String, Scriptable)
     * @see jscover.mozilla.javascript.ScriptableObject#putProperty(Scriptable, String, Object)
     * @see jscover.mozilla.javascript.Context#toObject(Object, Scriptable)
     */
     ...
     * @see jscover.mozilla.javascript.Scriptable#get(int, Scriptable)
     * @see jscover.mozilla.javascript.ScriptableObject#putProperty(Scriptable, int, Object)
     * @see jscover.mozilla.javascript.Context#toObject(Object, Scriptable)
     */
     ...
     * @see jscover.mozilla.javascript.Scriptable#get(String, Scriptable)
     * @see jscover.mozilla.javascript.ScriptableObject#deleteProperty(Scriptable, String)
     */
     ...
     * @param index the numeric index for the property
     * @see jscover.mozilla.javascript.Scriptable#get(int, Scriptable)
     * @see jscover.mozilla.javascript.ScriptableObject#deleteProperty(Scriptable, int)
     */
