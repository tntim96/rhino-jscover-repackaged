...
public class ContextFactory
{
    ...
    /**
     * Provides a default
     * {@link jscover.mozilla.javascript.xml.XMLLib.Factory XMLLib.Factory}
     ...
     */
    protected jscover.mozilla.javascript.xml.XMLLib.Factory
        getE4xImplementationFactory()
    {
        ...
        if (isDom3Present()) {
            return jscover.mozilla.javascript.xml.XMLLib.Factory.create(
                "jscover.mozilla.javascript.xmlimpl.XMLLibImpl"
            );
        } else if (Kit.classOrNull("org.apache.xmlbeans.XmlCursor") != null) {
            return jscover.mozilla.javascript.xml.XMLLib.Factory.create(
                "jscover.mozilla.javascript.xml.impl.xmlbeans.XMLLibImpl"
            );
        } else {
            return null;
        }
