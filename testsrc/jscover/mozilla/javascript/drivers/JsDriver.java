...
package jscover.mozilla.javascript.drivers;
...
import jscover.mozilla.javascript.tools.shell.*;
...
public class JsDriver {
    ...
    void run(Arguments arguments) throws Throwable {
        if (arguments.help()) {
            ...
            System.out.println("Consult the Java source code at testsrc/jscover/mozilla/javascript/JsDriver.java for details.");
            System.exit(0);
        }
    ...
    private static class Arguments {
        ...
        private Option lxrUrl = new Option("u", "lxrurl", false, false, "http://lxr.mozilla.jscover/mozilla/source/js/tests/");
