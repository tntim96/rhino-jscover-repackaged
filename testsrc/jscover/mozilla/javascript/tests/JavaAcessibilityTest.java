...
import jscover.mozilla.javascript.NativeJavaObject;
import jscover.mozilla.javascript.Script;
import jscover.mozilla.javascript.drivers.TestUtils;
import jscover.mozilla.javascript.tools.shell.Global;
import jscover.mozilla.javascript.tools.shell.ShellContextFactory;
...
public class JavaAcessibilityTest extends TestCase {
  ...
  String importClass = "importClass(Packages.jscover.mozilla.javascript.tests.PrivateAccessClass)\n";
